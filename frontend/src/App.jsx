  ...
  const handleDeleteUserData = async () => {
    ...
    try {
      window.dispatchEvent(
        new CustomEvent('smartstudy-research-withdrawal')
      );
            ...
            <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-slate-100 p-6">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-2.5 rounded-xl border border-slate-200 text-slate-600 font-semibold text-sm hover:bg-slate-50 transition-colors disabled:opacity-60"
                >
                  {t('withdrawal.cancel')}
                </button>
