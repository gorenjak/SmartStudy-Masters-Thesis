...
const resources = {
  en: {
    translation: {
      ...
      "lesson_card_desc": "Tailored content focusing on your specific learning style.",
      "open_lesson": "Open",
      ...
      "profile": {
        ...
        "description": "Answer a few short questions so SmartStudy can better adapt the content presentation.",
        "age": "Age",
        "select": "Select",
      ...
      "style_quiz": {
        "title": "Let's discover your learning style",
        "description": "Answer the questions below so we can tailor SmartStudy to your needs.",
        ...
        "submit": "Determine my style",
        "tie_title": "Both presentation modes suit you equally.",
        "tie_description": "Your responses indicate that both presentation modes suit you equally well. Please choose the one you would prefer to use while learning.",
      ...
      "survey": {
        ...
        "sus_trust_privacy_acceptance": "USER EXPERIENCE EVALUATION",
        ...
        // Acceptance
        "acceptance1": "I intend to use the SmartStudy platform again in the future.",
        "acceptance2": "I expect to use the SmartStudy platform again in the future.",
        "acceptance3": "I intend to use the SmartStudy platform for future learning.",
      ...
      "style_switch_question_visual": "Would you like to switch to visual learning mode?",
      "style_switch_question_verbal": "Would you like to switch to verbal learning mode?",
  ...
  sl: {
    translation: {
      ...
      "lesson_card_desc": "Prilagojena vsebina s poudarkom na vašem učnem stilu.",
      "open_lesson": "Odpri",
      ...
      "profile": {
        ...
        "description": "Odgovorite na kratka vprašanja, da lahko SmartStudy bolje prilagodi prikaz vsebine.",
        "age": "Starost",
        "select": "Izberite",
        "age_under_20": "Manj kot 20",
        "age_20_24": "20–24",
        "age_25_29": "25–29",
      ...
      "style_quiz": {
        "title": "Odkrijmo vaš učni slog",
        "description": "Odgovorite na spodnja vprašanja, da lahko SmartStudy prilagodimo vašim potrebam.",
        ...
        "submit": "Določi moj slog",
        "tie_title": "Oba načina predstavitve vam enako ustrezata.",
        "tie_description": "Vaši odgovori kažejo, da vam oba načina predstavitve ustrezata enako. Izberite tistega, ki bi ga raje uporabljali med učenjem.",
      ...
      "survey": {
        ...
        "sus_trust_privacy_acceptance": "OCENA UPORABNIŠKE IZKUŠNJE",
        ...
        // Sprejetost
        "acceptance1": "Platformo SmartStudy nameravam ponovno uporabljati tudi v prihodnje.",
        "acceptance2": "Pričakujem, da bom platformo SmartStudy ponovno uporabljal/-a tudi v prihodnje.",
        "acceptance3": "Platformo SmartStudy nameravam uporabljati tudi pri prihodnjem učenju.",
      ...
      "style_switch_question_visual": "Želite preklopiti na vizualni način učenja?",
      "style_switch_question_verbal": "Želite preklopiti na besedilni način učenja?",
